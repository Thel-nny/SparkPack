  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setMetrics({
        ...
        underwritingApplications: 15,
        declinedApplications: 8,
        pendingRenewals: 22,
      });
      setLoading(false);
    }, 1000);
          ...
          <>
            ...
            <Card className="p-4 flex items-center justify-between shadow-sm border border-l-4 border-[#A0D468] rounded-lg">
              <div className="flex flex-col justify-center">
                ...
                <p className="text-2xl font-bold text-[#A0D468] mt-0.5"> {/* Changed mt-1 to mt-0.5 */}
            ...
            <Card className="p-4 flex items-center justify-between shadow-sm border border-l-4 border-[#7eb238] rounded-lg">
              <div className="flex flex-col justify-center">
                <h3 className="text-sm font-medium text-gray-500">Underwriting</h3>
                <p className="text-2xl font-bold text-[#7eb238] mt-0.5"> {/* Changed mt-1 to mt-0.5 */}
            ...
            <Card className="p-4 flex items-center justify-between shadow-sm border border-l-4 border-[#5C8D2B] rounded-lg">
              <div className="flex flex-col justify-center">
                ...
                <p className="text-2xl font-bold text-[#5C8D2B] mt-0.5"> {/* Changed mt-1 to mt-0.5 */}
            ...
            <Card className="p-4 flex items-center justify-between shadow-sm border border-l-4 border-[#4F6F2E] rounded-lg">
              <div className="flex flex-col justify-center">
                <h3 className="text-sm font-medium text-gray-500">Pending Renewals</h3>
