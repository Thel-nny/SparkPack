  ...
  return (
    <div className="grid md:grid-cols-2 gap-8">
      <Card id="community-impact" className="p-8 bg-[#f5f7f8]">
        <h3 className="text-2xl font-bold text-[#342d47] mb-4">Projected Community Impact</h3>
      ...
      <Card id="local-events" className="p-8">
        <h3 className="text-2xl font-bold text-[#342d47] mb-4">Projected Upcoming Events</h3>
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <Calendar className="h-5 w-5 text-[#8cc63f] mt-1" />
            <div>
              <h4 className="font-semibold">Pet Health Fair</h4>
              <p className="text-gray-600 text-sm">March 15, 2026 • Iloilo Sports Complex</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <Calendar className="h-5 w-5 text-[#8cc63f] mt-1" />
            <div>
              ...
              <p className="text-gray-600 text-sm">March 22, 2026 • Sparkpack Memorial Forest</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <Calendar className="h-5 w-5 text-[#8cc63f] mt-1" />
            <div>
              ...
              <p className="text-gray-600 text-sm">April 5, 2026 • SM City Iloilo</p>
            </div>
          </div>
        </div>
      </Card>
